...
- The optional Print Lab Cloud link is outbound only. The cloud can approve or decline a waiting print request and nothing else; commands go through the same checks as the Family page (see docs/cloud-protocol.md). A command that does anything more would be a vulnerability.
